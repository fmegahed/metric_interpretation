...
We have created a [flexdashboard](https://pkgs.rstudio.com/flexdashboard/index.html)-based web application, which allows users to input the simulation paramaters of interest and output the corresponding simulation summary and histograms of our five classification metrics of interest. The application can be accessed [here](http://rstudio.fsb.miamioh.edu:3838/megahefm/metric_interpretation/) and the code used to create the application can be downloaded from [here](https://github.com/fmegahed/metric_interpretation/tree/main/app).
